...
/** \brief Permite realizar el test de la funcion addNode la cual es privadaint
 *
 * \param this LinkedList* Puntero a la lista
 * \param nodeIndex int Ubicacion donde se agregara el nuevo nodo
 * \param pElement void* Puntero al elemento a ser contenido por el nuevo nodo
...
int ll_count(LinkedList* this,int (*pFunc)(void*),int* contador)
{
    int retorno=0;
    void* elemento;
    int acumulador=0;
    int i;
    if(this!=NULL && pFunc!=NULL && contador!=NULL)
    {
        for(i=0;i<ll_len(this);i++)
        {
            elemento=ll_get(this,i);
...
int ll_countInt(LinkedList* this,int (*pFunc)(void*),int* contador)
{
    int retorno=0;
    int i;
    void* elemento;
    int auxiliar=0;
    if(this!=NULL && pFunc!=NULL && ll_len(this)>0 && contador!=NULL)
    {
        for(i=0;i<ll_len(this);i++)
        {
            elemento=ll_get(this,i);
...
int ll_countFloat(LinkedList* this,float (*pFunc)(void*),float* contador)
{
    int retorno=0;
    int i;
    void* elemento;
